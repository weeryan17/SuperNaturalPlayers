    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
    	if(cmd.getName().equalsIgnoreCase("mob")){
    		...
    		if(sender instanceof Player){
    			...
    			if(args.length == 1){
    				if(Main.dataConfig().getBoolean("Players." + player + ".Truce") == true){
    				if(args[0].equals("Zombie") || args[0].equals("zombie")){
    					if(Main.dataConfig().getInt("Players." + player + ".Souls") >= 4){
    					...
    					Main.dataConfig().set("Players." + player + ".Souls", souls - 4);
    					} else {
    					...
    					if(Main.dataConfig().getInt("Players." + player + ".Souls") >= 6){
    						int souls = Main.dataConfig().getInt("Players." + player + ".Souls");
    						...
    						Main.dataConfig().set("Players." + player + ".Souls", souls - 6);
    					} else {
    						sender.sendMessage(ChatColor.BLACK + "You don't have enough souls to do this");
    					}
    				} else if(args[0].equals("Cavespider") || args[0].equals("cavespider")){
    					if(Main.dataConfig().getInt("Players." + player + ".Souls") >= 20){
    						int souls = Main.dataConfig().getInt("Players." + player + ".Souls");
    						...
    						Main.dataConfig().set("Players." + player + ".Souls", souls - 20);
    					} else {
        						sender.sendMessage(ChatColor.BLACK + "You don't have enough souls to do this");
        					}
    					} else if(args[0].equals("ZombieHorse") || args[0].equals("zombiehorse")){
    						if(Main.dataConfig().getInt("Players." + player + ".Souls") >= 100){
    							int souls = Main.dataConfig().getInt("Players." + player + ".Souls");
    							...
    							Main.dataConfig().set("Players." + player + ".Souls", souls - 100);
    						} else {
        						sender.sendMessage(ChatColor.BLACK + "You don't have enough souls to do this");
        					}
